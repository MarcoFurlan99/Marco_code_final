...
def calculate_frechet_distance(mu1, sigma1, mu2, sigma2, eps=1e-6): # from https://github.com/mseitzer/pytorch-fid/blob/master/src/pytorch_fid/fid_score.py#L152
...
def calculate_source_normalized_frechet_distance(mu1, sigma1, mu2, sigma2, eps=1e-6):
    ...
    Formula from https://arxiv.org/abs/2006.16971, p.15."""
    mu1 = np.atleast_1d(mu1)
    mu2 = np.atleast_1d(mu2)
